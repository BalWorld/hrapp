...
<div class="page-title-box">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">All Resumes Available</h4>
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">HR App</a></li>
                    <li class="breadcrumb-item active">All Resumes</li>
                </ol>
            </div>
            <div class="col-md-4">
                <!-- Menu -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">View All Resumes</h4>
                        <p class="card-title-desc">View all Resumes. Manage Status/ Download Resume form
                            Action Button.
                        </p>
...
$(document).ready(function() {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [{
            ...
            },
            {
                "data": null,
                render: function(data, type, row) {
                    return '<a class="badge badge-primary p-2" href="uploads/jobresponse/' +
                        data["file"] +
            ...
            },
            {
                "data": null,
                render: function(data, type, row) {
                    return '<div class="dropdown"><a class="badge badge-light dropdown-toggle p-2"data-toggle="dropdown"type="button"aria-expanded="false"><i class="mdi mdi-dots-horizontal"></i></a><div class="dropdown-menu dropdown-menu-right"style=""><a class="dropdown-item text-dark" href="/resume/' +
                        data["id"] +
                        '">View More Details</a><a class="dropdown-item text-dark" href="/resume/edit/' +
                        data["id"] +
                        '">Edit Resume</a> <a class="dropdown-item text-dark" id="updateStatusBtn" data-dismiss="modal">Update Status</a> <a class="dropdown-item text-dark" onclick="deleteResponse(`' +
                        data["name"] + '`,`' +
    ...
    $('body').on('click', '#updateStatusBtn', function() {
        ...
        $('#modalId').attr('action', '/response/status/' + data["id"] + '');
...
function deleteResponse(name, id) {
    if (confirm("Are You Sure to delete " + name + " ?")) {
        window.location = "/responses/delete/" + id + "";
    }
