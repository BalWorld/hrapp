...
<div class="page-title-box">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">Add New Resume</h4>
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">HR App</a></li>
                    <li class="breadcrumb-item active">Add New Resume</li>
                </ol>
            </div>
            <div class="col-md-4">
                <!-- Side -->
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <!-- Not Added to DB-->
                                    <div class="form-group">
                                        <label for="secondary_skills">Secondary Skills <span class="small">[ Seperate
                                                by Commas eg:(skill, skill) ]</span></label>
                                        <input type="text" class="form-control" id="secondary_skills"
                                            name="secondary_skills" placeholder="Secondary Skills" value="" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="expected_ctc" name="expected_ctc"
                                            placeholder="Expected CTC" value="" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="current_organisation"
                                            name="current_organisation" placeholder="Current Organisation" value=""
                                            required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select form-control" id="client" name="client">
                                            <option value="No Client Selected">Select Client</option>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="location" name="location"
                                            placeholder="Current Location" value="" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="qualification" name="qualification"
                                            placeholder="Highest Qualification" value="" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
