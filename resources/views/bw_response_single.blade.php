...
<div class="page-title-box">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="page-title mb-1">Showing Details of {{ $jobresponse->name }}</h4>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="client" name="client"
                                        placeholder="Client" value="{{ $jobresponse->client }}" disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="">
                                    <p class="mb-1">
                                        <span class="badge badge-success p-2 mb-1 d-inline-block">Resume ID -
                                            {{ $jobresponse->id }}</span>
                                        <span class="badge badge-primary p-2 mb-1 d-inline-block">Created
                                            by -
                                            {{ $jobresponse->created_by_name }} </span>
                ...
                <div class="col-12">
                    <div class="form-group mb-0">
                        <button class="bg-primary bw-shadow" data-toggle="tooltip" title="Download Resume"
                            ...
                            onclick="javascript:window.open('/uploads/jobresponse/{{ $jobresponse->file }}','_blank')"
